...
{
    public class EtatFourmiAbrite : EtatPersonnageAbstrait
    {
        public override void AnalyseSituation(PersonnageAbstrait personnage)
        {
            Console.WriteLine(personnage.Nom + "(EtatFourmiAbrite) se trouve sur la zone : " + personnage.ZoneActuelle.Nom);
        }
